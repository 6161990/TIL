...
* ###### 참고 : [Is-a 와 Has-a의 관계](https://github.com/6161990/TIL/blob/main/Java/Polymorphism.md#round_pushpin-s-a%EC%83%81%EC%86%8D%EC%99%80-has-acomposition)
* ##### 클래스에서 상속의 의미
...
#### :round_pushpin: this.와 super. , super()
 ###### * 참고 : [this](https://github.com/6161990/TIL/blob/main/Java/This.md)
 * ##### 둘 다 재사용할 때 쓰인다. 
 * ##### this자기 자신 클래스 내부의 변수 메소드 생성자함수 재사용이고, super는 부모 클래스의 변수, 메소드, 생성자함수 재사용이다.
 * ##### this는 자기 자신을 가지고있는 메모리를 가리키고, super는 상위클래스의 메모리 위치, 참조값을 가리킨다.  
 * ##### super는 함수나 기능들을 수행하고 돌아가야한다. 생성자 함수는 저절로 상속이 되지않으니까 그걸 가져오겟다라는 의미로 super!!!
 ```java
 	(생략)
